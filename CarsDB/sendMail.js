	...
	async sendRegMail(to) {
		try{
			await this.transporter.sendMail({
				from: mail_user,
				to,
				subject: 'Регистрация РОЛЬФ МИНИ',
				text: '',
				html: `<h1>Вы были успешно зарегестрированны на сайте РОЛЬФ МИНИ</h1>
				<h4>Если это были не вы, свяжитесь с нами по телефону 89775380623</h4>`
				});
		}
		catch(e){
			console.log(e);
